# -*- coding: utf-8 -*-
"""
@CREATETIME: 2018/10/24 11:31 
@AUTHOR: X
@VERSION: 1.0
from 'https://github.com/chenkkkk/User-loan-risk-prediction/'
"""
...
if __name__ == '__main__':
    ...
    # %%
    train_bankcard = pd.read_csv(main_path + '/AI_risk_train_V3.0/train_bankcard_info.csv')
    "增加特征"
    ...
    # %%
    train_credit = pd.read_csv(main_path + '/AI_risk_train_V3.0/train_credit_info.csv')
    "增加特征"
    # 评分的反序
    ...
    # %%
    train_order = pd.read_csv(main_path + '/AI_risk_train_V3.0/train_order_info.csv', parse_dates=['time_order'])
    ...
    train_recieve = pd.read_csv(main_path + '/AI_risk_train_V3.0/train_recieve_addr_info.csv')
    ...
    # %%
    train_target = pd.read_csv(main_path + '/AI_risk_train_V3.0/train_target.csv', parse_dates=['appl_sbm_tm'])
    train_user = pd.read_csv(main_path + '/AI_risk_train_V3.0/train_user_info.csv')
    ...
    # %%
    test_auth = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_auth_info.csv', parse_dates=['auth_time'])
    ...
    # %%
    test_bankcard = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_bankcard_info.csv')
    "增加特征"
    ...
    test_bankcard_phone_count = test_bankcard.groupby(by=['id'], as_index=False)['phone'].agg(
        {'phone_count': lambda x: len(set(x))})
    # %%
    test_credit = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_credit_info.csv')
    # 信用评分反序
    ...
    # %%
    test_order = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_order_info.csv', parse_dates=['time_order'])
    ...
    # %%
    test_recieve = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_recieve_addr_info.csv')
    ...
    test_target = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_list.csv', parse_dates=['appl_sbm_tm'])
    test_user = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_user_info.csv', parse_dates=['birthday'])
    ...
    ans = pd.read_csv(main_path + '/AI_Risk_data_Btest_V2.0/test_list.csv', parse_dates=['appl_sbm_tm'])
    ...
    ans.to_csv(main_path + '/result/04094test.csv', index=None)
